...
struct TravelInfo {
    static let travel: [Travel] = [ // 인스턴스 프로퍼티로 사용
        ...
        Travel(title: "도쿄 타워",
               ...
               like: false,
               ad: false),
        Travel(title: "도쿄 여행 예약은?\nXcode로 직접 예약앱을 만들면 되겠네요!kkkkkkkkkkkkkkkkflsjglkfjglksjflgkjsl;fkjglsfkjglskfjglskfjglskjflgkjslfkgjlskfjglkfjglskfgjsfjgjhrllohrooolrklkfjglskj",
               description: nil,
               travel_image: nil,
               grade: nil,
               save: nil,
